...
import profilePic from '../../../assets/reviews/ProfilePicAnon.png'; // Ensure the correct path
...
const Reviews = () => {
  ...
  return (
    <div className='reviews-container'>
      ...
      <div className='review-bubbles-container'>
        <ReviewBubble 
          profilePicture={pfp1}
        ...
        <ReviewBubble 
          ...
          rating={5}
          reviewText="These wonderful people fixed my Supra Skytop sneakers (the best sneaker company that was ahead of the times and are not making shoes anymore). They gave my Supras a second life! Fantastic job and excellent customer service. Would def recommend! 10/10.
Top shelf business. Thank you very much!"
        />
        <ReviewBubble 
          profilePicture={pfp3}
